...
bool GuidedogDoc::readScript(QTextStream &stream, QString &errorstring) {
    ...
    while (true) {
        ...
        switch(i) {
            ...
            case 4:
                ...
                break;
            case 5:
                nomasqaddress = new IPRange();
                nomasqueradelist.append(*nomasqaddress);
    ...
    while (true) {
        if (s.startsWith("# [Forwarding]")) {
            ...
            rule = new GuidedogPortForwardRule();
            forwardrulelist.append(*rule);
        }
        if (s.startsWith("# [End]")) {
            break;  // We've got to the end of this part of the show.
        }
        ...
        switch(i) {
            ...
            case 1:
                rule->originalport = rightpart.toUInt();
                break;
